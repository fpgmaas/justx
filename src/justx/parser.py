...
from justx.exceptions import JustInvocationError, JustNotFoundError
from justx.models import Parameter, ParameterKind, Recipe, Source


class JustfileParser:
    """Parses justfiles into Source models by invoking just."""

    def parse(self, path: Path) -> Source:
        ...
        return Source(name=path.stem, path=path, recipes=recipes)
